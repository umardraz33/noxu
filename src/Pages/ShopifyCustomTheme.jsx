    ...
    <div class="breadcrumb-container">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><span class="medium-text">Shopify Plus Store Setup with Custom Theme</span></li>
            </ul>
        </div>
    </div>
   <div class="container">
           ...
           <div class="page-main-banner-colm col-lg-7 col-md-7">
                <div class="page-main-banner-content">
                    <div class="page-main-banner-content-list">
                        <h1 class="title">Shopify Plus Store Setup with Custom Theme</h1>
                        <div class="large-text content">
                            <p class="text">Are you planning to scale your Shopify business with the ever-growing features and functionalities of Shopify Plus?</p>
                            <p class="text">Noxu Technologies is the best Shopify Plus store setup with custom/premium theme
                                companies across the globe, with more than 8 years in the core Shopify industry. Our
                                experts combine world-class Shopify Plus platform expertise with advanced tools and
                                technology to develop a solution that creates high-volume business for our clients.</p>    
                        </div>
                    </div>
                </div>  
