...
const MagentoToShopify = () => {
  return (
        ...
        <div class="breadcrumb-container">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><NavLink to="/shopify-migration" class="medium-text">Migration</NavLink></li>
                    <li><span class="medium-text">Magento to Shopify Migration</span></li>
                </ul>
            </div>
        </div>
        <div class="container">
                ...
                <div class="page-main-banner-colm col-lg-7 col-md-7">
                    <div class="page-main-banner-content">
                        <div class="page-main-banner-content-list">
                            <h1 class="title">Top Magento to Shopify Migration Company</h1>
                            <div class="large-text content">
                                <p class="text">Are you planning to migrate from Magento to Shopify for more
                                    flexibility,
                                    reliability, and scalability?</p>
                                <p class="text">Noxu Technologies is a champion Magento to Shopify migration company to move
                                    all
                                    your Magento store data to Shopify securely. Our Magento to Shopify migration
                                    services
                                    will allow you to sell your products more effortlessly on the most powerful
                                    eCommerce
                                    platform Shopify.</p>
                                <p class="text">We maintain 100% of the data and functionalities available on the new
                                    Shopify store. Say goodbye to server hosting fees and the overhead cost of hiring a
                                    developer for minor changes by Magento to Shopify product migration.</p>
                            </div>
                        </div>
                    </div>
    ...
    <section class="diffrance-content-section section-inner-spacing">
        <div class="container">
            <div class="section-head-part">
                <h2 class="section-head-title">Why Should You Consider Magento to Shopify Migration?</h2>
            </div>
            ...
            <div class="diffrance-content-inner">
                <div class="diffrance-content-table">
                    <table cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><span class="icon-with-text"><b>Shopify is a drag-and-drop online store builder and easy to
                                    use.</b></span></td>
                            <td><span class="icon-with-text">Magento is difficult to use compared to Shopify.</span>
                            </td>
                        </tr>
                        <tr>
                            <td><span class="icon-with-text"><b>Shopify is easy to use and customize by just dragging
                                    elements
                                    wherever you want to place them.</b></span></td>
                            <td><span class="icon-with-text">Magento is difficult to customize as it will be needed
                                    coding.</span></td>
                        </tr>
                        <tr>
                            <td><span class="icon-with-text"><b>Shopify offers impressive sales tools like Abandoned cart
                                    recovery, Multi-channel selling, and collaborations with many courier
                                    services.</b></span>
                            </td>
                            <td><span class="icon-with-text">Need expensive extensions in order to add attractive sales
                                    tools in Magento.</span></td>
                        </tr>
                        <tr>
                            <td><span class="icon-with-text"><b>Shopify offers numerous impressive themes, including paid
                                    and
                                    free.</b></span></td>
                            <td><span class="icon-with-text">Magento (Adobe Commerce) offers limited themes, and themes
                                    are
                                    less impressive and simplistic.</span></td>
                        </tr>
                        <tr>
                            <td><span class="icon-with-text"><b>It offers powerful built-in marketing features and
                                    incredibly
                                    supports third-party integration for better reach.</b></span></td>
                            <td><span class="icon-with-text">Magento majorly relies on its marketplace for marketing
                                    tools.
                                    You will have to install extensions to run marketing campaigns.</span></td>
                        </tr>
                        <tr>
                            <td><span class="icon-with-text"><b>Shopify app store offer 8000 Shopify apps to add the latest
                                    features and functionalities.</b></span></td>
                            <td><span class="icon-with-text">Magento extension store offer 3072 extensions to add
                                    trending
                                    features and functionalities.</span></td>
                        </tr>
                        <tr>
                            <td><span class="icon-with-text"><b>Shopify theme store offers 12 free themes and 134 paid
                                    themes.</b> </span></td>
                            <td><span class="icon-with-text">The Magento theme store offers 8 themes.</span></td>
                        </tr>
                        <tr>
                            <td><span class="icon-with-text"><b>Shopify offers 14+ payment gateways.</b></span></td>
                            <td><span class="icon-with-text">Magento offers 7+ payment gateways.</span></td>
                        </tr>
                        <tr>
                            <td><span class="icon-with-text"><b>24X7 through live chat support and phone.</b></span></td>
                            <td><span class="icon-with-text">Magento doesn't offer any support through phone, live chat,
                                    or
                                    email. It is backed by the community support.</span></td>
                        </tr>
                        <tr>
                            <td><span class="icon-with-text"><b>It offers rock-solid data security with PCI-DSS compliance
                                    and
                                    SSL certification.</b></span></td>
                            <td><span class="icon-with-text">Magento has no in-built security features but is flexible
                                    to
                                    support manual security changes.</span></td>
                        </tr>
                        <tr>
                            <td><span class="icon-with-text"><b>You do not need any coding expertise or developers to make
                                    changes in your Shopify store.</b></span></td>
                            <td><span class="icon-with-text">Magento developers are required for the customization of
                                    the
                                    Magento store.</span></td>
                        </tr>
                        <tr>
                            <td><span class="icon-with-text"><b>Shopify allows easy store setup and enables quick time to
                                    deploy.</b></span></td>
                            <td><span class="icon-with-text">Magento is tough to manage and takes more time for online
                                    store
                                    development.</span></td>
                        </tr>
                        <tr>
                            <td><span class="icon-with-text"><b>Shopify is budget friendly and suitable for small or
                                    medium-scale businesses.</b></span></td>
                            <td><span class="icon-with-text">Magento is expensive as you will need to hire a team of
                                    developers to manage. It is suitable for small-scale businesses.</span></td>
                        </tr>
                        <tr>
                            <td><span class="icon-with-text"><b>Shopify's average server response speed is 609
                                    milliseconds.</b></span></td>
                            <td><span class="icon-with-text">Magento's average server response speed is 967
                                    milliseconds.</span></td>
                        </tr>
                    </tbody></table>
                </div>
                <p class="content">The bold points above indicate a better eCommerce platform than the Other one. So
                    undoubtedly, Shopify is way better than Magento (Adobe Commerce) for online store development. As a
                    leading Magento to Shopify migration agency, we highly recommend you migrate your Magento store to
                    Shopify.</p>
            </div>
    ...
    <section class="why-you-choose-us-section section-inner-spacing section-spacing mt-0">
        <div class="container">
            <div class="section-head-part">
                <h2 class="section-head-title">Why Should You Consider Noxu Technologies for Magento to Shopify Migration
                    Solutions?</h2>
                <p class="section-head-content">Being a top Magento to Shopify migration company, we lead the global
                    eCommerce industry. Our dedicated Shopify developers are well-versed in the latest eCommerce
                    insight,
                    advanced tools, and resources. Our Magento to Shopify migration checklist helps us to migrate all
                    data
                    of Magento with zero data loss.</p>
                <p class="section-head-content">
                    Our Shopify migration experts use their extensive expertise to move Magento store's all data,
                    including
                    CSV files, SKU variations, customer data, product categories, product attributes, listing titles,
                    inventory details, and order data transfer. We ensure seamless, reliable, and secure Magento to
                    Shopify
                    data migration services using exceptional Shopify migration apps like Matrixify, LitExtension, and
                    cart2cart.
                </p>
            </div>
            ...
            <div class="row row-mb-minus justify-content-center">
                <div class="col-md-4 col-sm-6 col-spacing-bottom">
                    <div class="why-you-choose-us-points">
                        <div class="icon-main">
                            <img loading="lazy" class="icon" src="assets/images/magento-to-shopify-migration-checklist.png" alt="Magento to Shopify Migration Checklist" width="70px" height="70px"/>
                        </div>
                        <h3 class="h6 title">Magento to Shopify Migration Checklist</h3>
                        <p class="medium-text text">Our Shopify migration developers discuss with the client before
                            migration what data or features they want to remove and what new features they are looking
                            to
                            add after migration. Experience the sales-oriented and high-performing Shopify store by
                            choosing
                            us as your Magento to Shopify product migration company.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-spacing-bottom">
                    <div class="why-you-choose-us-points">
                        <div class="icon-main">
                            <img loading="lazy" class="icon" src="assets/images/agile-migration-process-flow.png" alt="Agile Migration Process Flow" width="70px" height="70px"/>
                        </div>
                        <h3 class="h6 title">Agile Migration Process Flow</h3>
                        <p class="medium-text text">Magento database backup -&gt; Build a new Shopify store to import data
                            from
                            the existing Magento store -&gt; Set up Source &amp; Target cart -&gt; Choose data to migrate from
                            Magento
                            to Shopify -&gt; Run the complete migration -&gt; Follow post-migration guidelines for
                            future-ready
                            Shopify store.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-spacing-bottom">
                    <div class="why-you-choose-us-points">
                        <div class="icon-main">
                            <img loading="lazy" class="icon" src="assets/images/uninterrupted-salesforce-services-during-migration.png" alt="Uninterrupted Salesforce Services During Migration" width="70px" height="70px"/>
                        </div>
                        <h3 class="h6 title">Uninterrupted Salesforce Services During Migration</h3>
                        <p class="medium-text text">As a top-notch Magento to Shopify migration service provider, we are
                            experts in importing all data from the old Magento store to Shopify without interfering with
                            your running store operations. We guarantee zero data loss and zero downtime throughout the
                            migration process.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-spacing-bottom">
                    <div class="why-you-choose-us-points">
                        <div class="icon-main">
                            <img loading="lazy" class="icon" src="assets/images/coding.png" alt="Magento to Shopify Migration Expert" width="70px" height="70px"/>
                        </div>
                        <h3 class="h6 title">Magento to Shopify Migration Expert</h3>
                        <p class="medium-text text">With 8+ years of extensive experience Shopify development industry,
                            we
                            have immense knowledge and skills in delivering seamless Magento to Shopify migration
                            solutions.
                            We offer a dedicated point of contact during the complete migration process to maintain 100%
                            transparency and keep you updated about each migration stage.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-spacing-bottom">
                    <div class="why-you-choose-us-points">
                        <div class="icon-main">
                            <img loading="lazy" class="icon" src="assets/images/customer-service.png" alt="Post-launch Support" width="70px" height="70px"/>
                        </div>
                        <h3 class="h6 title">Post-launch Support</h3>
                        <p class="medium-text text">As an expert Magento to Shopify migration agency, we believe our
                            Shopify
                            migration services should add more value to clients' online businesses. So we provide
                            post-migration customer support to ensure better store performance and higher conversion
                            rates.
                        </p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-spacing-bottom">
                    <div class="why-you-choose-us-points">
                        <div class="icon-main">
                            <img loading="lazy" class="icon" src="assets/images/4-convenient-hiring-packages.png" alt="4 Convenient Hiring Packages" width="70px" height="70px"/>
                        </div>
                        <h3 class="h6 title">4 Convenient Hiring Packages</h3>
                        <p class="medium-text text">We know overall cost is one of the major reasons for moving towards
                            Magento to Shopify migrations. Noxu Technologies offers 4 convenient hiring packages keeping the
                            development cost concern in mind to provide you with affordable yet efficient Magento to
                            Shopify
    ...
    <section class="icon-and-text-grid-section section-spacing">
        <div class="container">
            <div class="section-head-part">
                <h2 class="section-head-title">What Data Can Noxu Technologies Migrate from Magento to Shopify?</h2>
                <p class="section-head-content">Noxu Technologies offers effortless and secure data migration from Magento to
                    Shopify with uninterrupted existing store operations and zero data loss. Our Shopify experts make it
                    very easy to import all your Magento data to the Shopify eCommerce platform, ensuring rigid data
                    security and zero downtime.</p>
            </div>
            <div class="row row-mb-minus justify-content-center">
                <div class="col-xl-4 col-lg-4 col-sm-6 col-spacing-bottom">
                    <div class="icon-and-text-grid-back">
                        ...
                        <p class="medium-text">Order details (date, order status, product details, history), Shipping &amp;
                            Billing Address, Customer details, etc.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-sm-6 col-spacing-bottom">
                    <div class="icon-and-text-grid-back">
                        ...
                        <p class="medium-text">Customer's name, Sign-up details, Credit &amp; Debit card details, Emails,
                            Billing &amp; Shipping address, etc.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-sm-6 col-spacing-bottom">
                    <div class="icon-and-text-grid-back">
                        <div class="icon-part">
                            <img loading="lazy" src="assets/images/what-data-migrate-7.png" width="70px" height="70px" alt="Content"/>
                        </div>
                        <h3 class="h6 title">Content</h3>
                        <p class="medium-text">Migrate blog posts, SEO URLs, and all descriptions.</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-sm-6 col-spacing-bottom">
                    <div class="icon-and-text-grid-back">
                        ...
                        <p class="medium-text">Coupons name, offer date, expiration date, coupon codes, and many more.
                        </p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-sm-6 col-spacing-bottom">
                    <div class="icon-and-text-grid-back">
                        ...
                        <p class="medium-text">Static pages like the About Us page, Home page, and Privacy policy page.
                        </p>
                    </div>
                </div>
            </div>
...
<section id="workflow_section_two" class="workflow-section section-spacing">
    <div class="container">
        <div class="section-head-part">
            <h2 class="section-head-title">Our Strategic Migration Process to Serve Your Convenience</h2>
            <p class="section-head-content">As a top Magento to Shopify migration service provider, our skilled Shopify migration developers are committed to following a demonstrated and effective import process. It enables bug-free, streamlined, quick, and seamless Magento to Shopify migration services.</p>
        </div>
...
<div class="contact-banner-secound-section section-spacing">
        <div class="container">
            <div class="contact-banner-secound-background">
                <div class="line-background"><img loading="lazy" src="assets/images/background-line.png" width="600px" height="240px" alt="line background"/></div>
                <div class="contact-banner-secound-content">
                    <h3 class="h4 title">Let's get in touch to skyrocket your <span>eCommerce business growth.</span>
                    </h3>
                    <p class="content">Schedule 15-minute free consultations to understand what we can do to elevate
                        your
                        online business.</p>
                    <NavLink to="/contact-us" ><span class="button white-button">Discuss with Our Migration Expert</span></NavLink>
                </div>
            </div>
        </div>
    </div>
