  ...
  return (
        ...
        <div class="breadcrumb-container">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><span class="medium-text">Wix to Shopify</span></li>
                </ul>
            </div>
        </div>
        <div class="container">
                    ...
                    <div class="page-main-banner-content">
                        <div class="page-main-banner-content-list">
                            ...
                            <div class="large-text content">
                                <p class="text">Have you got bored with poor flexibility, poor scalability, and poor sales growth?</p>
                                <p class="text">Migrate Wix to Shopify to keep your eCommerce store booming as you scale through a new Shopify store. Noxu Technologies is the most trusted and passionate Wix to Shopify migration service provider. Our skilled Shopify migration experts manage all data migration with ease to back your business with an online store that is ready to go out of the box. Our Wix to  Shopify migration service will help you dynamically upscale your online business.</p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="section-head-part">
            <h2 class="section-head-title">Why should you consider Wix to Shopify migration?</h2>
            <p class="section-head-content">One of the most significant <b>disadvantages of Wix</b> is that it is not scalable &amp; flexible. It restricts you from adding custom code and features that are available on other platforms. So, it is a daunting task for business owners to expand their business without rebuilding it from scratch.</p>
            <p class="section-head-content"><b>Migration from Wix to Shopify </b> is the perfect solution at your doorstep to overcome these disadvantages of Wix. <b>Wix to Shopify migration</b> is quite a challenging and time-consuming task. However, Noxu Technologies, as Wix to Shopify migration company, guarantee seamless and secure migration in no time.</p>
            <p class="section-head-content">The following comparison will justify why you should <b>migrate Wix to Shopify</b> eCommerce platform.</p>
        </div>
        ...
        <div class="diffrance-content-inner">
            <div class="diffrance-content-table">
                <table cellspacing="0" cellpadding="0">
                    <tbody><tr>
                        <th><h3 class="h5 title">Shopify</h3></th>
                        <th><h3 class="h5 title">Wix</h3></th>
                    </tr>
                    <tr>
                        <td><span class="icon-with-text"><b>Shopify is highly scalable.</b></span></td>
                        <td><span class="icon-with-text">Wix completely restricts you to scale.</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon-with-text"><b>Shopify themes are fully mobile responsive.</b></span></td>
                        <td><span class="icon-with-text">Wix themes are not much mobile responsive.</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon-with-text"><b>Advanced Shopify offers detailed sales reporting.</b></span></td>
                        <td><span class="icon-with-text">Wix does not offer sales reporting.</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon-with-text"><b>Shopify offers free slogan-maker tools.</b></span></td>
                        <td><span class="icon-with-text">Wix does not offer any slogan maker tool.</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon-with-text"><b>100+ payment gateways.</b></span></td>
                        <td><span class="icon-with-text">50+ payment gateways</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon-with-text"><b>Allows unlimited product listing on the store to sell.</b></span></td>
                        <td><span class="icon-with-text">Allows only 5000+ products listed on the store to sell.</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon-with-text"><b>6000+ Shopify apps available on the Shopify store.</b></span></td>
                        <td><span class="icon-with-text">Only 250+ apps are available in the Wix app store.</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon-with-text"><b>Shopify has collaborated with various sales channels like Meta, Instagram, Pinterest, Walmart, TikTok, etc. It allows you to sell everywhere.</b></span></td>
                        <td><span class="icon-with-text">Wix has collaborated with  Meta and Instagram only. It restricts you from selling everywhere.</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon-with-text"><b>Suitable for all sizes of businesses, from startups to enterprise level.</b></span></td>
                        <td><span class="icon-with-text">Suitable only for the small size of businesses.</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon-with-text"><b>Shopify allows you to add as many web pages as you want.</b></span></td>
                        <td><span class="icon-with-text">Wix allows only 100 web pages on the website.</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon-with-text"><b>Shopify offers unlimited bandwidth, which means it will not charge when your website gets higher traffic.</b></span></td>
                        <td><span class="icon-with-text">Free Wix offers only 500MB storage and 500MB bandwidth.</span></td>
                    </tr>
                    <tr>
                        <td><span class="icon-with-text"><b>Shopify immensely support third-party API integrations to add custom features and functionalities.</b></span></td>
                        <td><span class="icon-with-text">Wix allows limited third-party APi integration.</span></td>
                    </tr>
                </tbody></table>
            </div>
            <p class="content">The bold points above indicate a better eCommerce platform than the other one. Shopify sets itself apart as the best store development platform than Wix for creating and maintaining online stores. As a leading <b>Wix to Shopify migration service provider,</b> we highly recommend you migrate Wix to Shopify. </p>

            <p class="content"><b>Migration from OpenCart to Shopify</b> will help you improve the user experience, improve the scalability, improve the store performance, improve the site loading speed, improve conversion rates, and boost sales growth.</p>
        </div>
...
<section class="why-you-choose-us-section section-inner-spacing section-spacing mt-0">
    <div class="container">
       <div class="section-head-part">
           <h2 class="section-head-title">Why Should You Consider Noxu Technologies for Wix to Shopify Migration Services?</h2>
           <p class="section-head-content">Wix eCommerce platform is advisable for small size of businesses with limited products or services. If you are planning to scale your online business to the next level, Wix has limitations. Migrating from Wix to Shopify store is the best possible solution to scale online business and improve flexibility.</p>
            <p class="section-head-content">
                We, as a trusted Wix to Shopify migration agency, can help you with improved SEO ranking, better flexibility, incredible features, and functionalities. Our dedicated team of Shopify migration experts utilizes their years of expertise and core technical knowledge to deliver profitable Shopify stores.
            </p>
            <p class="section-head-content">Here are the significant reasons to choose our Wix to Shopify product migration services.</p>
        </div>   
       ...
       <div class="row row-mb-minus justify-content-center">
           <div class="col-md-4 col-sm-6 col-spacing-bottom">
               <div class="why-you-choose-us-points">
                   <div class="icon-main">
                       <img loading="lazy" class="icon" src="assets/images/business-runs-smoothly-during-migration.png" width="70px" height="70px" alt="Business Runs Smoothly During Migration"/>
                   </div>
                   <h3 class="h6 title">Business Runs Smoothly During Migration</h3>
                   <p class="medium-text text">Our automated Wix to Shopify Migration Services ensures smooth Salesforce operations in the existing Wix store and secure data import during the migration process.</p>
               </div>
           </div>
           <div class="col-md-4 col-sm-6 col-spacing-bottom">
               <div class="why-you-choose-us-points">
                   <div class="icon-main">
                       <img loading="lazy" class="icon" src="assets/images/magento-to-shopify-migration-checklist.png" width="70px" height="70px" alt="Pre-Migration Guidance"/>
                   </div>
                   <h3 class="h6 title">Pre-Migration Guidance</h3>
                   <p class="medium-text text">As per the client's business requirements, our Shopify migration experts suggest to them which features they must consider and which they should not. It ensures quick and cost-effective migration.</p>
               </div>
           </div>
           <div class="col-md-4 col-sm-6 col-spacing-bottom">
               <div class="why-you-choose-us-points">
                   <div class="icon-main">
                       <img loading="lazy" class="icon" src="assets/images/customer-service.png" width="70px" height="70px" alt="Post-Launch Support"/>
                   </div>
                   <h3 class="h6 title">Post-Launch Support</h3>
                   <p class="medium-text text">We, as a top Wix to Shopify migration agency, verify all data imported from Wix store to ensure zero data loss. Our Shopify migration developers also take care of data migration which is updated in the existing Wix store during migration.</p>
               </div>
           </div>
           <div class="col-md-4 col-sm-6 col-spacing-bottom">
               <div class="why-you-choose-us-points">
                   <div class="icon-main">
                       <img loading="lazy" class="icon" src="assets/images/solid-data-security.png" width="70px" height="70px" alt="Unmatched Data Security"/>
                   </div>
                   <h3 class="h6 title">Unmatched Data Security</h3>
                   <p class="medium-text text">Having 8 years of experience, we understand the importance of clients' data security. We are the trusted Wix to Shopify migration company; sign a strict NDA and other legal documents to secure your idea &amp; confidential data.</p>
               </div>
           </div>
           <div class="col-md-4 col-sm-6 col-spacing-bottom">
               <div class="why-you-choose-us-points">
                   <div class="icon-main">
                       <img loading="lazy" class="icon" src="assets/images/keep-our-clients-updated.png" width="70px" height="70px" alt="Stay Updated about Migration Stages"/>
                   </div>
                   <h3 class="h6 title">Stay Updated about Migration Stages</h3>
                   <p class="medium-text text">We provide a dedicated point of contact during Wix to Shopify migration service. Our dedicated Shopify migration expert keeps you updated about the actual migration status and addresses your query or concerns.</p>
               </div>
           </div>
           <div class="col-md-4 col-sm-6 col-spacing-bottom">
            <div class="why-you-choose-us-points">
                <div class="icon-main">
                    <img loading="lazy" class="icon" src="assets/images/affordable-price.png" width="70px" height="70px" alt="Affordable Cost"/>
                </div>
                <h3 class="h6 title">Affordable Cost</h3>
                <p class="medium-text text">We minimize the overhead Wix to Shopify migration service costs by following strategic workflow and eliminating unnecessary feature requirements. You can pick any plan from our 4 flexible hiring plans as per your business requirements.</p>
            </div>
        </div>
       </div>
    </div>
 ...
 <div class="talk-to-exp-section section-spacing">
                    ...
                    <div class="talk-to-exp-profile d-flex align-items-center">
                        ...
                        <div class="talk-to-exp-info">
                            <div class="expert-name">
                                <h4 class="title"><span>Muhammad</span> .png</h4>
    ...
    <div class="container">
        <div class="section-head-part">
            ...
            <p class="section-head-content">Being the best Wix to Shopify migration agency, our skilled Shopify migration developers are committed to following a simple yet effective and efficient data import process. It ensures bug-free, easy, faster, and secure Wix to Shopify migration. We manage all exported files, import processes, and imported data.</p>
        </div>
            ...
            <div class="workflow-step-wrap row-mb-minus">
                <div class="workflow-single col-spacing-bottom">
                    <div class="workflow-single-back">
                        <div class="image">
                            <img loading="lazy" class="icon" src="assets/images/conversation.png" width="51px" height="51px" alt="Discuss Project Needs"/>
                        </div>
                        <span class="workflow-count">01</span>
                        <h3 class="h6 title">Discuss Project Needs</h3>
                        <ul class="small-text workflow-content">
                            <li>Our dedicated Shopify migration experts discuss with clients to find what are the exact project needs.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="workflow-single col-spacing-bottom">
                    <div class="workflow-single-back">
                        <div class="image">
                            <img loading="lazy" class="icon" src="assets/images/planing.png" width="51px" height="51px" alt="Planning"/>
                        </div>
                        <span class="workflow-count">02</span>
                        <h3 class="h6 title">Planning</h3>
                        <ul class="small-text workflow-content">
                            <li>After knowing clients' requirements, we prepare strategic planning for an uninterrupted Wix to Shopify migration process. It enables us to deliver robust Wix to Shopify product migration that meets clients' requirements.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="workflow-single col-spacing-bottom">
                    <div class="workflow-single-back">
                        <div class="image">
                            <img loading="lazy" class="icon" src="assets/images/web-design 1.png" width="51px" height="51px" alt="Designing &amp; Development"/>
                        </div>
                        <span class="workflow-count">03</span>
                        <h3 class="h6 title">Designing &amp; Development</h3>
                        <ul class="small-text workflow-content">
                            <li>Our professional Shopify migration experts use extensive expertise, core technical background, latest tools and techniques to deliver a custom-made user experience and sales-oriented Wix to Shopify migration services.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="workflow-single col-spacing-bottom">
                    <div class="workflow-single-back">
                        <div class="image">
                            <img loading="lazy" class="icon" src="assets/images/test.png" width="51px" height="51px" alt="QA Testing"/>
                        </div>
                        <span class="workflow-count">04</span>
                        <h3 class="h6 title">QA Testing</h3>
                        <ul class="small-text workflow-content">
                            <li>We assure the quality by UAT before releasing the final product. Our QA specialists perform rigid quality testing to make sure the quality of the online store is unparalleled.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="workflow-single col-spacing-bottom">
                    <div class="workflow-single-back">
                        <div class="image">
                            <img loading="lazy" class="icon" src="assets/images/startup 2.png" width="51px" height="51px" alt="UAT &amp; Deploy"/>
                        </div>
                        <span class="workflow-count">05</span>
                        <h3 class="h6 title">UAT &amp; Deploy</h3>
                        <ul class="small-text workflow-content">
                            <li>After assuring the quality, we go for user acceptance testing to ensure end-to-end features and functionality from the customer side. After getting approval from the client, the Shopify store is ready to launch.</li>
                        </ul>
                    </div>
                </div>
